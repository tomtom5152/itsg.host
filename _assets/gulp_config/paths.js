...
paths.jsPattern       = '/**/*.js';
paths.imagePattern    = '/**/*.+(jpg|JPG|jpeg|JPEG|pdf|PDF|png|PNG|ico|ICO|svg|SVG|gif|GIF|webmanifest|webp|WEBP|tif|TIF|xml|XML)';
...
paths.vendorJsFilesGlob = [
  ...
  paths.nodeDir + "highlight.js/lib/casper.js"
];
